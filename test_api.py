...
# Step 1: Load the .env file from the current directory
...
if not GOOGLE_API_KEY:
    ...
    print("Please make sure your .env file is in the main project folder and contains: GOOGLE_API_KEY='YourKeyHere'")
else:
    ...
    try:
        ...
        model = genai.GenerativeModel('gemini-pro') # Using a standard, common model
        ...
        print("\nError Details:")
        print(e) # This will print the exact error from Google
